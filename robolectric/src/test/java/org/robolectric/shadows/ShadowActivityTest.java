...
public class ShadowActivityTest {
  ...
  public void getLastIntentSenderRequest() throws IntentSender.SendIntentException {
    ...
    PendingIntent pendingIntent = PendingIntent.getActivity(systemContext, requestCode,
        intent, 0);
    ...
    activity.startIntentSenderForResult(
        intentSender, requestCode, fillInIntent, flagsMask, flagsValues,
        extraFlags, options);
  ...
  public void startIntentSenderForResult_throwsException() {
    ...
    IntentSender intentSender = PendingIntent.getActivity(
          systemContext, 0, new Intent("action"), 0)
        .getIntentSender();
